...
function changeType(e) {
    ...
    if (e.getAttribute("id") == "text-button") {

        $("#text-post").classList.remove("shown");
        $("#text-post").classList.add("hidden");

        $("#media-post").classList.remove("hidden");
        $("#media-post").classList.add("shown");
    }
    else {
  
        $("#media-post").classList.remove("shown");
        $("#media-post").classList.add("hidden");

        $("#text-post").classList.remove("hidden");
        $("#text-post").classList.add("shown");
    }
}
